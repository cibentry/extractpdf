...
$pendingquery = "SELECT COUNT(*) as pendingcount from daily_booking where booking_status = 'pending' AND mapped_zone_id = '$mid'";
        ...
        <div class="row">
            ...
            <div class="col-sm-12 my-1 mx-2 ">
                <div class="row">
                    ...
                    $showdata = "SELECT entry_date,entry_no, sm_name,customer_name, vehicle_registration_no, chassi_number, commissionable_premium FROM daily_booking
                                WHERE booking_status = 'pending' and mapped_zone_id = '$mid'";
                    ...
                    if ($disrow > 0) {
                        ...
                        while ($fetchdata = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td>' . htmlspecialchars($fetchdata['entry_no']) . '</td>';
                            ...
                            echo '<td>';
                            echo '<a href="edit_entry.php?id=' . htmlspecialchars($fetchdata['entry_no']) . '" class="btn btn-sm btn-primary">Edit</a>'; // Edit button
