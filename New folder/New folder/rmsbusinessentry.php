...
<body>
    <div class="container-fluid m-auto mx-1 ">
        ...
        <div class="cont my-1 "><!----- Entry form starts -------->
            ...
            <div class="col-sm-12 m-1 p-2 mx-auto">
                <form action="rmssavedata.php" method="post" enctype="multipart/form-data"
                            ...
                            <div
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 m-1 p-2 ">
                                        ...
                                        <input type="text" id="rsd" name="rsd" class="form-control my-1"
                                            title="YYYY-MM-DD" onchange="setred()" required>
                                    </div>
                                    <div class="col-sm-2 m-1 p-2 ">
                                        <label for="red" class="form-control my-1">Risk End Date
                                        </label>
                                        <input type="text" id="red" name="red" class="form-control my-1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 m-2 p-2">
                                        <input type="text" id="odoutward" name="odoutward"
                                            class="form-control my-1 text-success" onchange="validateinput()" required>
                                    </div>
                            ...
                            <div
                                ...
                                <div class="row">
                                    <div class="col-sm-4 m-2 p-2">
                                        ...
                                        <p1 class="fw-bold"> Click to calculate commission</p1>
                                    </div>
                                    <div class="col-sm-2 m-2 p-2">
    ...
    <script>
        function toggleMarginInput() {
            ...
            var odoutward = parseFloat(document.getElementById("odoutward").value);
            var tpoutward = parseFloat(document.getElementById("tpoutward").value);
            var netoutward = parseFloat(document.getElementById("netoutward").value);
            var totalod = parseFloat(document.getElementById("totalodpremium").value);
            var totaltp = parseFloat(document.getElementById("totaltppremium").value);
            var net = parseFloat(document.getElementById("netpremium").value);


            if (odoutward != 0 && tpoutward == 0) {
                var inwardcommission = "0";
                var marginc = "0";
                var outwardcommission = commissionablepremium * (odoutward / 100);
                ...
                if (odoutward == 0 && tpoutward != 0) {
                    var inwardcommission = "0";
                    var marginc = "0";
                    var outwardcommission = commissionablepremium * (tpoutward / 100);
                    document.getElementById("outcommission").value = outwardcommission.toFixed(2);
                    document.getElementById("incommission").value = inwardcommission.toFixed(2);
                    document.getElementById("margin").value = marginc.toFixed(2);
                }
                    ...
                    if (odoutward != 0 && tpoutward != 0) {
                        ...
                        var inwardcommission = "0";
                        var marginc = "0";
                        var outwardcommission = commissionablepremium * (netoutward / 100);
                        document.getElementById("outcommission").value = outwardcommission.toFixed(2);
                        document.getElementById("incommission").value = inwardcommission.toFixed(2);
                        document.getElementById("margin").value = marginc.toFixed(2);
                    }
