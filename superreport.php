...
<body>
    ...
    <div class="cont my-1 ">
        ...
        <div class="row">
            <div class="cont my-1">
                <div class="col-12 col-sm-6 col-md-1 ">
                    <a href="superuser.php" class="btn btn-secondary btn-lg active m-3 mx-3" role="button"
                        aria-pressed="true">Dashboard</a>
                </div>
            </div>

            <div class="col-sm-12 my-1">
                <form action="superreportdownload.php" method="post" enctype="multipart/form-data">
