...
<body>
    ...
    <div class="cont my-1 ">
        <div class="row">
            <div class="cont my-1">
                <div class="col-12 col-sm-6 col-md-1 ">
                    <a href="agent.php" class="btn btn-secondary btn-lg active m-3 mx-3" role="button"
            ...
            <div class="col-sm-12 m-2">
                <div class="row">
                    <div class="row">
                        ...
                        $total_records_query = "SELECT COUNT(*) as total FROM `daily_booking` WHERE `sm_name` = '$_SESSION[username]' AND `month_name` = '$monthName' and f_year = '$fiscalYear' and booking_status = 'booked' and pos_code = '$poscode'";
                    ...
                    <form method="POST" action="agentreportdownload.php">
                        <div class="row mx-5">
                            <div class="col-sm-4">
