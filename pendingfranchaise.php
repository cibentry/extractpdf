...
$pendingquery = "SELECT COUNT(*) as pendingcount from franchaise_booking where booking_status = 'pending'";
...
<body>
    ...
    <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">Pending Franchaise</h5>
        ...
        <div class=" border border-primary mx-3 bg-primary bg-gradient bg-opacity-10 shadow-sm p-3 mb-5">
                ...
                <div class="list-group m-3">
                    ...
                    <a href="pendinfranchaise.php" class="list-group-item list-group-item-action">
                        Pending Entry
                        <?php if ($pendingcount > 0): ?>
                            <span class="badge bg-danger ms-2"><?php echo $pendingcount; ?></span>
                        <?php endif; ?>
                    </a>
                    <a href="franchaisereport.php" class="list-group-item list-group-item-action active">Report Download</a>
    ...
    <div class="container-fluid m-auto mx-1 ">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 my-1 mx-2 ">
                <div class="row">
                    <?php
                    $showdata = "SELECT entry_date,our_entry_no, sm_name,customer_name, vehicle_registration_no, chassi_number, commissionable_premium FROM franchaise_booking
                    ...
                    if ($disrow > 0) {
                        ...
                        while ($fetchdata = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td>';
                            echo '<a href="franchaise_edit_entry.php?id=' . htmlspecialchars($fetchdata['our_entry_no']) . '" class="btn btn-sm btn-primary">Edit</a>'; // Edit button
