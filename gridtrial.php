    ...
    <script>
        function redirectToPage() {
            ...
            if (selectedValue === '1') {
                ...
                window.location.href = 'gridmpcv.php';   
            }else if (selectedValue === '4') {
                window.location.href = 'gridpvt.php';
            }else if (selectedValue === '5') {
                window.location.href = 'gridtwhrm.php';
            }else if (selectedValue === '6') {
                window.location.href = 'gridhealthrm.php';
            }
        }
    </script>
...
function redirectToGrid() {
    ...
    if(selectedValue == "1") {
        window.location.href = "gridgcv.php?productText=" + encodeURIComponent(selectedText);
    } else if(selectedValue == "2") {
        window.location.href = "gridmiscdrm.php?productText=" + encodeURIComponent(selectedText);
    }else if(selectedValue == "3") {
        window.location.href = "gridpcv.php?productText=" + encodeURIComponent(selectedText);
    }else if(selectedValue == "4") {
        window.location.href = "gridpvt.php?productText=" + encodeURIComponent(selectedText);
    }else if(selectedValue == "5") {
        window.location.href = "gridtwhrm.php?productText=" + encodeURIComponent(selectedText);
    }else if(selectedValue == "6") {
        window.location.href = "gridhealthrm.php?productText=" + encodeURIComponent(selectedText);
    }
}
</script>
