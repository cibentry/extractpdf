    ...
    <div class="row">
        <div class="col-sm-3 border border-primary mx-3 bg-primary bg-gradient bg-opacity-10 shadow-sm p-3 mb-5">
            ...
            <div class="list-group m-3">
                <a href="directors.php" class="list-group-item list-group-item-action">Home</a>
                ...
                <a href="directorsheadsearch.php" class="list-group-item list-group-item-action">Commission Report</a>
            </div>
            <h4 class="report bg-primary m-1 p-1 text-light">Reports</h4>
            <div class="list-group m-3">
