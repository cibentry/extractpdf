        ...
        <div class="container-fluid border border-primary rounded bg-primary bg-gradient ">
                    <div class="row">
                        <div class="col-10 col-sm-6 col-md-10">
                            ...
                            echo "<p class='text-light mx-3'>Employee ID : <em>" . $fetch['code'] . "</em></p>"; // Changed to italic // Added line to show ID
                            ?>
                        </div>
...
<div class="cont my-1 ">
    ...
    <div class="row">
        ...
        <div class="col-sm-8 my-1">
            ...
            <div class="row">
               <?php
                    $zonequery = "SELECT mapped_zone_id FROM `login_master` WHERE `name`='$_SESSION[username]'";
