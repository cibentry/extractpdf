                ...
                <div class="col-sm-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <a href="superdelete.php" class="btn btn-primary">Proceed</a>
                        </div>
                        <div class="card-footer text-body-secondary">
            ...
            <div class="col-sm-4">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <a href="superreport.php" class="btn btn-primary">Proceed</a>
                    </div>
                    <div class="card-footer text-body-secondary">
            ...
            <div class="col-sm-4">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <a href="superedit.php" class="btn btn-primary">Proceed</a>
                    </div>
                    <div class="card-footer text-body-secondary">
