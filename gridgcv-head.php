...
<body>
                ...
                <form action="showgrid.php" method="post">
                    <div class="row border border-success">
                        ...
                        <div class="col-sm-2 m-4 ">
                            ...
                            <input type="button" class="btn btn-secondary" value="Reset" onclick="resetFormExceptProductType()">
                        </div>
    ...
    <script>
  function resetFormExceptProductType() {
    var form = document.querySelector('form'); // assuming you have a form element
    var productTypeInput = form.querySelector('#product-type'); // assuming the product-type textbox has an ID of "product-type"
    
    // reset all form fields except product-type
    Array.prototype.forEach.call(form.elements, function(element) {
      if (element !== productTypeInput) {
        element.value = '';
      }
    });
    
    // redirect to gridtrial-head.php
    window.location.href = 'gridtrial-head.php';
  }
</script>
    <script>
