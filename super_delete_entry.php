...
<body>
    <div class="container mt-1">
        <form method="POST" action="itupdate_entry.php">
                        ...
                        <div class="row"><!--- Start of row ----->
                            ...
                            <div class="col-sm-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="margin" name="margin"
                                    value="<?php echo htmlspecialchars($row['margin']); ?>" required>
                            </div>
                        </div>
                    </div><!--- End of row ----->
                    <hr class="my-3 border-success">
                    <div class="row"><!--- start of row ----->
                        ...
                        <div class="col-sm-4 mb-3">
                            ...
                            <select class="form-control" id="bookingstatus" name="bookingstatus" required>
                                ...
                                <option value="<?php echo htmlspecialchars($row['booking_status']); ?>" <?php echo ($row['booking_status'] != 'Booked') ? 'selected' : ''; ?>>
