...
<body>
    ...
    <div class="cont my-1 ">
        ...
        <div class="row">
            ...
            <div class="col-sm-8 my-1 ">
                <form action="showgridtwhrms.php" method="post">
                    <div class="row border border-success">
                        ...
                        <div class="col-sm-2 m-1 ">
                            ...
                            <select class="form-select" name="state-name" id="state-name"
                                ...
                                <?php
                                $query = mysqli_query($con, "SELECT DISTINCT state_name FROM grid_twh ORDER BY state_name ASC;") or die(mysqli_error());
                        ...
                        <div class="col-sm-2 m-1 ">
                            ...
                            <select class="form-select" name="policy-type" id="policy-type"
                                ...
                                <?php
                                $query = mysqli_query($con, "SELECT DISTINCT Policy_type FROM grid_twh order by Policy_type ASC") or die(mysqli_error());
                                while ($fetch = mysqli_fetch_array($query)) {
                        ...
                        <div class="col-sm-2 m-1 ">
                            <label for="twhtype" class="form-label">Vehicle Type</label>
                            <select class="form-select" name="twhtype" id="twhtype" 
    ...
    <script>
        function selectinsurer() {
            ...
            var twh = document.getElementById("twhtype").value;
            //alert(state);
            console.log("State: " + state + ", Policy: " + policy + ", twh: " + twh);

            $.ajax({
                url: "showinsurertwhrm.php",
                type: "POST",
                data: {
                    state: state,
                    policy: policy,
    ...
    <script>
        function displaygrid() {
            ...
            var vtype = document.getElementById("twhtype").value;
            var month = document.getElementById("gridmonth").value;


            console.log(state + " " +  policy + " " + cc + " "+ insurer + " " + age + " " + vtype + " " + month);

            //alert(insurer);

            $.ajax({
                type: "POST",
                url: "showgridtwhrms.php",
                data: {
