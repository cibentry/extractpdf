            ...
            <div class="col-sm-12 m-2">
                <div class="row">
                    <div class="row">
                        ...
                        $policyquery = "SELECT entry_no, entry_date, month_name,sm_name, customer_name, vehicle_registration_no, segment, policy_start_date, policy_end_date, total_premium, net_premium FROM `daily_booking`WHERE booking_status='Booked' LIMIT $offset, $limit";
                        $result = mysqli_query($con, $policyquery);

                        $total_records = mysqli_num_rows(mysqli_query($con, "SELECT * FROM `daily_booking` where booking_status = 'Booked'"));
