...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/material-design-icons/3.0.1/iconfont/MaterialIcons-Regular.ttf">
</head>
        ...
        <div class="row">
            <div class="col-sm-3 border border-primary mx-3 bg-primary bg-gradient bg-opacity-10 shadow-sm p-3 mb-5">
                ...
                <div class="list-group m-3">
                    <a href="agent.php" class="list-group-item list-group-item-action active">Home</a>
                    <a href="agentbusinessreport.php" class="list-group-item list-group-item-action">Business Summary</a>
                    <a href="agentpolicytransaction.php" class="list-group-item list-group-item-action">Policy
                        Transaction</a>
                    <a href="agentmtdpolicytransaction.php" class="list-group-item list-group-item-action">MTD Policy
                        Transaction</a> 
            ...
            <div class="col-sm-8">
                <div class="row">
                    <div class="row border border-danger rounded bg-warning bg-gradient bg-opacity-10 shadow-sm mx-1 ">
                        <form method="post" action="agentsearchentry.php">
    ...
    <script>
        $(document).ready(function(){
            $("#submit").on('click',function(e){
                ...
                $.ajax({
                    url: 'agentsearchentry.php', // url for backend operation
                    type: 'POST',
                    data: {
                        searchby: searchby,
