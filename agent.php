            ...
            <div class="row">
                <div
                    ...
                    <div class="list-group m-3">
                        ...
                        <a href="agentbusinessreport.php" class="list-group-item list-group-item-action">Business
                            Summary</a>
                        <a href="agentpolicytransaction.php" class="list-group-item list-group-item-action">Policy
                            Transaction</a>
                        <a href="agentmtdpolicytransaction.php" class="list-group-item list-group-item-action">MTD
                            Policy
                            Transaction</a>
                        <a href="agententryreport.php" class="list-group-item list-group-item-action">Entry Report</a>
                        <a href="agentsearch.php" class="list-group-item list-group-item-action">Search</a>
                    </div>
                            ...
                            <div class="card text-white bg-primary mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    $mtd = "SELECT SUM(net_premium) AS total_commission
                                                FROM daily_booking WHERE pos_code = '$poscode' AND f_year = '$fiscalYear'";
                        ...
                        <div class="col-sm-3 my-1">
                            <div class="card text-white bg-success mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    $fiscalYear = $fiscalYearStart . '-' . substr($fiscalYearEnd, -2); // e.g., "2024-25"
                                    $mtd = "SELECT SUM(net_premium) AS total_commission
                                               FROM daily_booking WHERE pos_code='$poscode' AND month_name = '$monthName'";
                                    $mtdquery = mysqli_query($con, $mtd);
                                    if ($mtdquery) {
                                        $row = mysqli_fetch_assoc($mtdquery);
                                        $total_commission = $row['total_commission'] ?? 0;
                        ...
                        <div class="card text-white bg-info mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                    ...
                                    $fiscalYear = $fiscalYearStart . '-' . substr($fiscalYearEnd, -2); // e.g., "2024-25"
                                    $mtd = "SELECT SUM(net_premium) AS total_commission
                                               FROM daily_booking WHERE pos_code = '$poscode' AND entry_date = '$currentDate'";
                                    $mtdquery = mysqli_query($con,$mtd) ;
                                    if($mtdquery){
                                        $row = mysqli_fetch_assoc($mtdquery);
                                        $total_commission = $row['total_commission'] ?? 0;
