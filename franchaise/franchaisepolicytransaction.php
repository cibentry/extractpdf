                ...
                <div class="row">
                    <div class="row">
                        ...
                        $policyquery = "SELECT entry_no, entry_date, month_name, sm_name, customer_name, vehicle_registration_no, segment, policy_start_date, policy_end_date, total_premium, net_premium 
                                        FROM `franchaise_booking` 
                                        WHERE `sm_name` = '$_SESSION[username]'
                                        LIMIT $offset, $limit";

                        $result = mysqli_query($con, $policyquery);

                        $total_records_query = "SELECT COUNT(*) as total FROM `franchaise_booking` WHERE `sm_name` = '$_SESSION[username]'";
                    ...
                    <form method="POST" action="franchaisereportdownload.php">
                        <div class="row mx-5">
                            <div class="col-sm-4">
