...
<body>
                ...
                <form action="showgrid.php" method="post">
                    <div class="row border border-success">
                        ...
                        <div class="col-sm-2 m-1 ">
                                ...
                                <input type="text" class="form-control" name="rtocode" id="rtocode" onchange="selectstate()" required>
                        </div>
                        <div class="col-sm-2 m-1 ">
                                <label for="state-name" class="form-label">State Name</label>
                                <input type="text" class="form-control" name="state-name" id="state-name" required readonly>
                        </div>
    ...
    <script>
        function selectinsurer() {
            ...
            //alert(state);
            console.log("State: " + state + ", Policy: " + policy + ", GVW: " + gvw + ", Vehicle Type: " + vehicletype);
...
<script>const rtocodeInput = document.getElementById('rtocode');

rtocodeInput.addEventListener('input', () => {
  const value = rtocodeInput.value;
  const cleanedValue = value
    .toUpperCase() // convert to uppercase
    .replace(/ /g, '') // remove spaces
    .replace(/[^a-zA-Z0-9]/g, ''); // remove special characters
  rtocodeInput.value = cleanedValue;
});
</script>
</body>
